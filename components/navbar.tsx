...
export default function NavBar({ page }: any){
    ...
    return (<div className="mb-0 md:px-10  md:py-2 flex flex-row items-center justify-between sticky z-50 order-last md:order-first bottom-0 md:top-0 w-full bg-white">
