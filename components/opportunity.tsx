...
export default function Opportunity({ opportunity }: any){
    return (
        <div className="w-full flex flex-col gap-2 p-2">
            ...
            {opportunity.images.length > 0 ? <Image src={`https://reponse_backend-1-r0934826.deta.app/images/view/${item.images[0]}`} alt="image" width={900} height={500} className="w-full h-fit object-scale-down"/> : null}
